<%@page import="com.admin.otp.CheckSessionOTP"%>
<%@page import="com.admin.bean.AdminOTP"%>
...
<%
	...
	if (!CheckSessionOTP.checkSession(key))
...
form {<!--
    ...
    <form name="registration" method="post" >
    	Name <input type="text" name="firstname" id="firstname" placeholder="Username" /> </br>
        Current Password <input type="password" name="password" id="password" placeholder="Password"  /> 
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<h3>&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
				&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
				&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; Change Password</h3>
			<form id="formProfile" action="forgotChangePassword" method="post"
				name="registration" class="form-horizontal">


				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-2"> New Password </label>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-2"> Confirm Password </label>
...
<script>
	...
	/*$('#formProfile').submit(function(e) {
		e.preventDefault();
		var username = $('input#form-field-1').val();
		var password = $('input#form-field-2').val();
